...
export default function ListOfConsulting() {
  ...
  return (
    ...
    //   </h1>
    //   <div className="flex flex-wrap justify-center w-3/4 md:w-11/12 gap-x-12 md:gap-x-6 md:flex-col md:items-center">
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       <Link to="/consulting/planning-for-growth">
    ...
    //     </div>
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       <Link to="/consulting/business-unit-strategy">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Business Unit
    //           <br /> Strategy
    //         </p>
    ...
    //     </div>
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       <Link to="/consulting/portfolio-evaluation">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Portfolio
    //           <br /> Evaluation
    //         </p>
    ...
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       {" "}
    //       <Link to="/consulting/brand-management">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Brand
    //           <br /> Management
    //         </p>
    ...
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       {" "}
    //       <Link to="/consulting/geographical-expansion">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Geographical
    //           <br /> Expansion
    //         </p>
    ...
    //     </div>
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       <Link to="/consulting/mergers-and-acquisitions">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Mergers and
    //           <br />
    //           Acquisitions
    ...
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       {" "}
    //       <Link to="/consulting/divestiture">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Divestiture
    //         </p>
    //         <p className="text-gray2 text-base hover:text-navyblue my-2">
    ...
    //     </div>{" "}
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       <Link to="/consulting/strategising-fundraise-for-growth">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Strategising
    //           <br /> Fundraise
    //         </p>
    ...
    //     <div className="flex flex-col gap-4 w-1/5 md:w-11/12 mt-16">
    //       {" "}
    //       <Link to="/consulting/business-valuation">
    //         <p className="text-navyblue text-xl font-semibold md:text-xl">
    //           Business
    //           <br /> Valuation
    //         </p>

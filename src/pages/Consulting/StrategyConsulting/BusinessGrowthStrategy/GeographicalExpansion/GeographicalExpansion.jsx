...
export default function GeographicalExpansion() {
  const user = useSelector((state) => state.user.user);

  return (
    <section
      id="Geographical-Expansion"
    ...
    >
      <div className="w-1/2 flex flex-col gap-8 justify-between md:w-full md:items-center md:flex-col-reverse">
        <div className="flex flex-col gap-6 md:w-11/12">
          <h1>
            Geographical <br className="md:hidden" /> Expansion
          </h1>
          <Link
        ...
        <img
          src="./Assets/Images/strategic/geography1.jpg"
        />
      </div>
      <div className="flex flex-col w-2/5 gap-8 md:w-full md:items-center ">
        <img
          src="./Assets/Images/strategic/geography2.jpg"
        />
        <div className="flex flex-col gap-6 md:w-11/12">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-justify font-normal text-lg md:text-base text-gray2 pl-10">
              Crafting tailored strategies for successful market entry
            </p>
          </div>
          <div className="flex flex-col gap-2">
            <div className="flex gap-4 md:items-center">
            ...
            <p className="text-justify font-normal text-lg md:text-base text-gray2 pl-10">
              Facilitating mergers, acquisitions, and strategic alliances for
              expansion
            </p>
          </div>
        </div>
